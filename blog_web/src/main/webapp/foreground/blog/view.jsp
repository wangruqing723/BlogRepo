...
<script src="${pageContext.request.contextPath}/static/layuimini/lib/layui-v2.5.5/layui.all.js"
        ...
        if ($.trim(content) == '') {
            ...
            $.post("${pageContext.request.contextPath}/comment/save.do", {
                ...
                if (result.success) {
                    ...
                    layer.msg(result.errorInfo, {icon: 2, time: 2000});
                }
            }, "json");
        }
    }
                ...
                <c:forEach var="comment" items="${commentList }" varStatus="status">
                    <c:choose>
                        <c:when test="${status.index<10 }">
                            <div class="comment">
                                <span>
                                    <font>${status.index+1 }楼&nbsp;&nbsp;&nbsp;&nbsp;${comment.userIp }：</font>${comment.content }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[&nbsp;
...
<div class="data_list">
    ...
    <div class="publish_comment">
        ...
        <div class="verCode">
            验证码：<input maxlength="4" type="text" value="${imageCode }" name="imageCode" id="imageCode" size="10"
                       onkeydown="if(event.keyCode==13) submitData()"/>&nbsp;<img onclick="javascript:loadimage();"
