        ...
        <ul>
            <c:forEach var="blog" items="${blogList}">
                <li style="margin-bottom: 30px">
                    ...
                    <span class="summary">
                        <a href="${pageContext.request.contextPath}/blog/articles/${blog.id}.html"><font color="black">摘要: ${blog.summary }...</font></a>
                    </span>
                    <span class="img">
                    ...
                    <span class="info">发表于 <fmt:formatDate value="${blog.releaseDate }" type="date"
                                                           pattern="yyyy-MM-dd HH:mm:ss"/> 阅读(${blog.clickHit}) 评论(${blog.replyHit})
                    </span>
                </li>
