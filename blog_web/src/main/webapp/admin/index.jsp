...
<head>
    ...
    <link rel="icon" href="${pageContext.request.contextPath}/static/layuimini/images/favicon.ico">
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layuimini-header-content">
            ...
            <ul class="layui-nav layui-layout-right">
                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;"><security:authentication property="principal.username"/></a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" data-title="基本资料" data-icon="fa fa-gears"
                               layuimini-content-href="${pageContext.request.contextPath}/admin/modifyInfo.jsp">基本资料
                                <span class="layui-badge-dot"></span>
                            </a>
                        </dd>
                        <dd>
                            <a href="javascript:;" data-title="修改密码" data-icon="fa fa-gears"
                               layuimini-content-href="${pageContext.request.contextPath}/admin/modifyPassword.jsp">修改密码
                            </a>
                        </dd>
                        <dd>
                            <hr>
    ...
    <!--无限极左侧菜单-->
    <div id="left-menu" class="layui-side layui-bg-black layuimini-menu-left"></div>
...
<script>
    layui.use(['element', 'jquery', 'layer', 'miniAdmin', 'miniTongji'], function () {
        var $ = layui.jquery,
        ...
        var options = {
            iniUrl: "${pageContext.request.contextPath}/static/layuimini/api/init.json",    // 初始化接口
            clearUrl: "${pageContext.request.contextPath}/static/layuimini/api/clear.json", // 缓存清理接口
        ...
        $('.login-out').on("click", function () {
            layer.msg('退出系统成功', {icon: 6, time: 1000},
                function () {
